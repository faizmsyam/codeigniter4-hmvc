...
defined('APP_NAMESPACE_CORE') || define('APP_NAMESPACE_CORE', 'App\\Core');
defined('APP_NAMESPACE_MODULES') || define('APP_NAMESPACE_MODULES', 'App\\Modules');

defined('APP_DESCRIPTION') || define('APP_DESCRIPTION', 'Application license by FMS Signature');
